...
namespace Alpha\Framework\Database\Orm\Relations;

use Alpha\Framework\Support\Arr;
use Alpha\Framework\Support\Str;
use Alpha\Framework\Database\Orm\Model;
use Alpha\Framework\Database\Orm\Builder;
use Alpha\Framework\Database\Orm\Collection;
...
class BelongsToMany extends Relation
{
     ...
     * @param  int|null  $page
     * @return \Alpha\Framework\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  array  $columns
     * @param  string  $pageName
     * @return \Alpha\Framework\Contracts\Pagination\Paginator
     */
     ...
     *
     * @param  \Alpha\Framework\Database\Orm\Builder  $query
     * @param  \Alpha\Framework\Database\Orm\Builder  $parent
     ...
     *
     * @param  \Alpha\Framework\Database\Orm\Builder|null  $query
     * @return $this
     */
     ...
     *
     * @param  array   $models
     * @param  \Alpha\Framework\Database\Orm\Collection  $results
     * @param  string  $relation
     * @return array
     */
     ...
     *
     * @param  \Alpha\Framework\Support\Collection|array  $models
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Alpha\Framework\Database\Orm\Model|\Alpha\Framework\Database\Orm\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Alpha\Framework\Support\Collection|\Alpha\Framework\Database\Orm\Model
     */
     ...
     *
     * @param  \Alpha\Framework\Database\Orm\Collection|array  $ids
     * @return array
     */
