...
use Alpha\Framework\Pagination\LengthAwarePaginator;
use Alpha\Framework\Support\MacroableTrait;
use Alpha\Framework\Database\Query\Grammar;
use Alpha\Framework\Database\Query\Processor;
use Alpha\Framework\Support\ArrayableInterface;
use Alpha\Framework\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var \Alpha\Framework\Database\Query\WPDBConnection
     */
     ...
     *
     * @var \Alpha\Framework\Database\Query\Grammar
     */
    protected $grammar;
     ...
     *
     * @var \Alpha\Framework\Database\Query\Processor
     */
    protected $processor;
     ...
     *
     * @param  \Alpha\Framework\Database\ConnectionInterface  $connection
     * @param  \Alpha\Framework\Database\Query\Grammar  $grammar
     * @param  \Alpha\Framework\Database\Query\Processor  $processor
     * @return void
     */
     ...
     * @return \Alpha\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\Alpha\Framework\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \Alpha\Framework\Database\Query\Builder|static
     *
     ...
     *
     * @param  \Alpha\Framework\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Alpha\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \Alpha\Framework\Database\Query\Builder|static
     */
     ...
     * @param  int|null  $page
     * @return \Alpha\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Alpha\Framework\Pagination\PaginatorInterface
     */
     ...
     *
     * @param  mixed  $value
     * @return \Alpha\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \Alpha\Framework\Database\ConnectionInterface
     */
     ...
     *
     * @return \Alpha\Framework\Database\Query\Processor
     */
     ...
     *
     * @return \Alpha\Framework\Database\Query\Grammar
     */
